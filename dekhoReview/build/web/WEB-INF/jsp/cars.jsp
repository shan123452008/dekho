...
<div class="container"><section id="content"><form:form method="post" action="cars.do" modelAttribute="cars" enctype="multipart/form-data">
	<table>
		<tr>
			<td></td>
		...
		<tr>
			<td>Car Name</td>
			<td><input type="text" placeholder="Car Name" name="carName" id="carName"/></td>
		</tr>
		<tr>
			<td>Company Name</td>
