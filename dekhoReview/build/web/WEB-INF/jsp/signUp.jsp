...
<div class="container"><section id="content"><form:form method="post" action="loginUser.do" modelAttribute="user" enctype="multipart/form-data">
	<table>
		<tr>
			<td></td>
		...
		<tr>
			<td>Phone Number</td>
			<td><input type="text" placeholder="Phone" name="mobNumber" id="mobNumber"/></td>
		...
		<tr>
			<td>Picture you want to share"</td>
			<td><input type="file" name="uploadImage" id="uploadImage" /></td>
		</tr>
		
		<tr>
			<td>Comments  for your picture</td>
			<td><input type="text" placeholder="Comment your pic" name="comment" id="comment"/></td>
