        	...
        	<div id="posts-list" class="cf">        	
				...
				<article class="format-standard">
					<div class="feature-image">
						  <%= session.getAttribute("detailsBlog") %>
					</div>
					<div class="box cf">
						...
						<div class="excerpt">
							<div class="post-heading" ><%= session.getAttribute("haedingBlog") %></div>
							<div class="entry-content">
							
							<%= session.getAttribute("detailsDivTextBlog") %>
						...
						<div class="meta">
							...
							<span class="user"><a href="#"><%= session.getAttribute("haedingBlog") %>, </a></span>
					...
					<ol class="commentlist">
					    ...
					    <li class="comment even thread-even depth-1" id="li-comment-4">
					     ...
					     -->
					    							...
					    							<%= session.getAttribute("commentBlog") %>
				...
				<form:form method="post" action="commentBlog.do" modelAttribute="commentBlog">
...
<!-- 				  	<p class="comment-form-url"><label for="url">Website</label><input id="url" name="url" type="text" value="" size="30"></p>
 -->  					
					...
					<p class="form-submit">
						...
						<input type="hidden" name="comment_post_ID" value="<%= session.getAttribute("userIdBlog")%>" id="comment_post_ID">
