...
<div class="container"><section id="content"><form:form method="post" action="blog.do" modelAttribute="blog" enctype="multipart/form-data">
	<table>
		<tr>
			<td></td>
		...
		<tr>
			<td>Blog Name</td>
			<td><input type="text" placeholder="Blog Name" name="blogname" id="blogname"/></td>
		</tr>
		...
		<tr>
			<td>Comments  for Blog with details</td>
