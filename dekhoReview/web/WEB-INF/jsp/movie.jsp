...
<div class="container"><section id="content"><form:form method="post" action="movie.do" modelAttribute="movie" enctype="multipart/form-data">
	<table>
		<tr>
			<td></td>
		...
		<tr>
			<td>Movie Name</td>
			<td><input type="text" placeholder="Movie Name" name="moviename" id="moviename"/></td>
		</tr>
		
		<tr>
			<td>Actor/Actress Name</td>
			<td><input type="text" placeholder="Actor/Actress Name" name="actName" id="actName"/></td>
		</tr>
		...
		<tr>
			<td>Comments  for Movie with details</td>
